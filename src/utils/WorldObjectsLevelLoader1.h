...
class WorldObjectsLevelLoader1 : public LevelLoader1 {
public:
    WorldObjectsLevelLoader1() {}
...
//                e->addComponent<CDialogue>();
        ...
        if(layer["name"] == "enemyboundary") {
            ...
            for(auto object : objects) {
                ...
                e->addComponent<CBoundingBox>(Vec2{(float) level->m_worldConfig.tileWidth, (float) level->m_worldConfig.tileHeight}, false, false);
            }
        }
